...
class Preprocessor:
    ...
    def tokenization(self, sentence, lowercase=True, no_repeated_term=False, remove_repeated_letters=True, remove_abbreviation=False, remove_stops=True, remove_punc=True):
        ...
        Ex:
            ...
            tokens: []
            tokens_p: [('there', 'NORMAL'), ('is', 'NORMAL'), ('a', 'NORMAL'), ('very', 'NORMAL'), ('important', 'NORMAL'), ('decision', 'NORMAL'), ('to', 'NORMAL'), ('make', 'NORMAL'), ('.', 'NORMAL'), ('check', 'NORMAL'), ('https://google.com', 'URL'), ('<3', 'EMOTICON'), ('#godnight', 'HASHTAG')]
        """
